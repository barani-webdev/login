...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    <body>
        <center><b><h1  style='font-family:Bell MT'>Dean Details</b></h1><center>
        <div class="row text-center">
        <div class="col-sm-11" style="margin-left:40px;background: linear-gradient(#007bb2,#0d1423);border-radius:15px;"><br>
      ...
      <a href="admindashboard.php"><i class="fa fa-arrow-left" style="margin-left:-1050px;font-size:23px;"></i></a>
        ...
        <br>
          ...
          <th>Date</th>
            ...
            <a href="edit.php?id=<?php echo $c['id'];?>"> <i class='fa fa-edit' style='font-size:24px;color:#357ec7'></i></a>
            </td>
            <?php							
        echo"</tr>";
      }
