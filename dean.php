<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $signup_query= "INSERT INTO `dean`(`id`, `uname`, `phone`, `email`, `date`, `permission`, `password`) VALUES ('','$uname','$phone','$email','$date','$permission','$password')"; 
        
        $check_query= "SELECT * FROM `dean` WHERE uname='$uname' or email='$email'";
