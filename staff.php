<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $signup_query= "INSERT INTO `staff`(`id`, `uname`, `phone`, `email`, `date`,`department`, `permission`, `password`) VALUES ('','$uname','$phone','$email','$date','$department','$permission','$password')"; 
        
        $check_query= "SELECT * FROM `staff` WHERE uname='$uname' or email='$email'";
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    <style>
        body
        {
            ...
            align-items: center;
            min-height: 100vh;
            background: linear-gradient(rgb(250, 250, 79),#0d1423);    
            }
       .card
       {
        position: relative;
    ...
    <body>
        <div class="card">
            ...
            <div class="details">
                <center><b><h1 style="font-family:Bell MT;font-size:25px;">Create Staff</b></h1><br>
