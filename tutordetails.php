<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    <body>
        <center><b><h1  style='font-family:Bell MT'>Tutor Details</b></h1><center>
        <div class="row text-center">
        <div class="col-sm-11" style="margin-left:40px;background:  linear-gradient(rgb(245, 59, 59),#0d1423);border-radius:15px;"><br>
        ...
        <br>
            ...
            <?php
              ...
              echo"<td>";?>
              <a href="delete2.php?id=<?php echo $c['id'];?>">
              <i class='fa fa-trash' style='font-size:25px;color:#dc381f;'></i></a>&nbsp &nbsp &nbsp
              <a href="tutoredit.php?id=<?php echo $c['id'];?>"> <i class='fa fa-edit' style='font-size:24px;color:#357ec7'></i></a>
              </td>
              <?php						
        echo"</tr>";
      }
